    ...
    render() {
        return (
            ...
            <ImageBackground source={require('../../assets/NextBack.png')} style={{ flex: 1, alignItems: 'center', justifyContent: 'space-evenly', paddingLeft: 20, paddingRight: 20, }}>
                ...
                <TextInput onChangeText={(e)=> {this.setState({email:e})}} style={{ width: '90%', height: 40, backgroundColor: 'yellow' }} />
                <Text >
                  {this.state.email}
                </Text>

                <TouchableOpacity onPress={()=> this.setState({email:"sahaab"})}  style={{ width: '90%', height: 40, backgroundColor: 'red' }} >
